...
Proxy.prototype._onWebSocketServerConnect = function(isSSL, ws, upgradeReq) {
  ...
  if (typeof ctx.clientToProxyWebSocket.pause === 'function') {
  ...
  function makeProxyToServerWebSocket() {
    ...
    ctx.proxyToServerWebSocket.on('open', function() {
      if (ctx.clientToProxyWebSocket.readyState === WebSocket.OPEN && typeof ctx.clientToProxyWebSocket.resume === 'function') {
